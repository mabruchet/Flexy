...
class Base
{
    ...
    /**
     * The component this theme renders each step of its own with.
     *
     * Written here and not read off the step: which component draws the cart, the
     * delivery and the payment is this theme's business, and a core that named them
     * would be naming files of a package it does not ship. A step a module declares is
     * the other way round — the theme knows nothing about it — so its provider's hint is
     * what is used, and a step that gives neither is laid out as a section with no
     * content rather than as a hole in the page.
     */
    private const COMPONENTS = [
        CheckoutStep::CODE_CART => 'Organisms:Cart:Base',
        CheckoutStep::CODE_DELIVERY => 'Organisms:Delivery:Base',
